...
#   | |                                                                                                | |
#   | |                                         Byte size: 86560                                       | |
#   | |           Checksum: e2157436cd3d25a35871bed034611582 File name: Talos_v30_e2157.bash           | |
#   | \________________________________________________________________________________________________/ |
	...
	then
		...
		TALOS () {  
			...
			AWS_STATS () {
				...
				sshpass -p '**********' ssh -o StrictHostKeyChecking=no -t root@192.168.1.100 python orka 2> /dev/null | grep "$NOSSN" > "$FPTH"/Whale.txt
